...
import com.github.rozdBugs.CodeSignIssue;
...
public class Main extends Sprite {
    public function Main() {
        ...
        new PlainButton(this, { y: -50, w: 280, label: "IsSupported"}, function (): void {
            trace(CodeSignIssue.isSupported);
            output.text += CodeSignIssue.isSupported + "\n";
        });
